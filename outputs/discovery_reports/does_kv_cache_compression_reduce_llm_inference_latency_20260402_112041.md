...
**3.** and computation, ensuring GPU memory is allocated to the most critical prefixes while masking the I/O overhead associated with KV cache transmission.
   - Source: *HotPrefix: Hotness-Aware KV Cache Scheduling for Efficient Prefix Sharing in LLM Inference Systems*
   - Domain: `transformer_efficiency`

**4.** These mechanisms significantly improve cache hit rates, reduce inference latency, and enhance throughput.
   - Source: *HotPrefix: Hotness-Aware KV Cache Scheduling for Efficient Prefix Sharing in LLM Inference Systems*
   - Domain: `transformer_efficiency`

**5.** Implemented in the SGLang framework, HotPrefix reduces inference latency and increases throughput by up to 2.25× compared with vLLM with prefix sharing enabled.
   - Source: *HotPrefix: Hotness-Aware KV Cache Scheduling for Efficient Prefix Sharing in LLM Inference Systems*
   - Domain: `transformer_efficiency`
