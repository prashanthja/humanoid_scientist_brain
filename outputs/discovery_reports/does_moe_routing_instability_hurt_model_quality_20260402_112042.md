...
**2.** Furthermore, we develop an adaptive router that optimizes inference efficiency by profiling the distribution of routing weights and determining a layer-wise policy that balances accuracy and latency.
   - Source: *LaDiMo: Layer-wise Distillation Inspired MoEfier*
   - Domain: `transformer_efficiency`

**3.** We demonstrate the effectiveness of our method by converting the LLaMA2-7B model to a MoE model using only 100K tokens, reducing activated parameters by over 20% while keeping accuracy.
   - Source: *LaDiMo: Layer-wise Distillation Inspired MoEfier*
   - Domain: `transformer_efficiency`

**4.** Our approach offers a flexible and efficient solution for building and deploying MoE models.
   - Source: *LaDiMo: Layer-wise Distillation Inspired MoEfier*
   - Domain: `transformer_efficiency`
